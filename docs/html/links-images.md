...
สำหรับ checkpoint หลัก ใช้ `<img>` กับ `alt` ก็พอ ส่วน `figure`/`figcaption` เป็นทางเลือกเมื่อต้องการคำบรรยายใต้ภาพ
:::
...
ไปที่ [Semantic HTML](/html/semantic) เพื่อจัด `header`, `nav`, `main` และ `footer`
