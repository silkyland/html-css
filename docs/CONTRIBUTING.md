...
- ใช้โปรเจกต์ `my-shop-profile` และแบรนด์ “กาแฟบ้านดอย” ต่อเนื่องในบทสอนทั้งหมด เพื่อให้โค้ดสะสมตรงกัน
- เปลี่ยนชื่อแบรนด์และเนื้อหาได้เฉพาะช่วง Capstone ซึ่งระบุให้ผู้เรียนปรับชิ้นงานเป็นของตนเองอย่างชัดเจน โดยยังใช้ไฟล์และ repository เดิม
